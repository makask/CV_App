    ...
    return(
        <div className="left-panel-container">
            <div className="left-panel-menu">
                ...
                <h2 onClick={()=>setSection('Assignments')}><i className="fa fa-tasks" aria-hidden="true"></i> Assignments</h2>
                <h2 onClick={()=>setSection('Advertisements')}><i className="fa fa-newspaper-o" aria-hidden="true"></i>Job advertisements</h2>
            </div>
        </div>
    );
}
